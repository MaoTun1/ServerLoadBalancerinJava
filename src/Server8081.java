...
public class Server8081 extends Thread {
    ...
    public Server8081(int port) throws SocketException {
    ...
    public static void main(String[] args) {
        int port = 8081; // You can change this to any port you want
        try {
            Thread server = new Server8081(port);
            server.start();
