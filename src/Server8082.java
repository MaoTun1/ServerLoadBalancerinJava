...
public class Server8082 extends Thread {
    ...
    public Server8082(int port) throws SocketException {
    ...
    public static void main(String[] args) {
        int port = 8082; // You can change this to any port you want
        try {
            Thread server = new Server8082(port);
            server.start();
